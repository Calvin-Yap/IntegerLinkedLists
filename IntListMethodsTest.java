...
public class IntListMethodsTest {
    ...
    public static void main(String[] args) {
        int seed = 777 ;//Integer.parseInt(args[0]);
        int rounds = 10;//Integer.parseInt(args[1]);
        int size = 1000000;//Integer.parseInt(args[2]);
        int total;
        try {
        total = test(seed, rounds, size, false);//args.length > 3 && args[3].toLowerCase().startsWith("t"));
        }
